...
public enum PipelineWarning {
     ...
     * pipe after end of input</i>. Make sure to override the workers' <code>join</code> in a way that handles that, or
     * that the input never ends in a race condition between the relevant workers.
     */
